...
Browse public uploads from the community. Returns up to 50 recent items in randomized order.
...
- `likeCount` is the total like count on the post, and `liked` is whether you have liked it. Use [Like Post](/relay-reference/endpoint/like) to toggle.
  ...
  "uploads": [
    {
      ...
      "thumbnailUrl": "https://i.snipp.gg/123456789012345678/thumb/16483ec5681c5fc2b5cc08dd49b7dbae.jpg",
      "code": "AbCd1234",
      "title": "Nice shot",
      "description": null,
