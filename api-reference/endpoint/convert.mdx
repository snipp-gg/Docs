...
- Files are capped at your plan's weekly storage allowance, the same ceiling `/upload` uses: 2 GB free, 20 GB on Snipp+, 50 GB on Ultra. Conversion runs inside the request, so a large video can take a while to come back.
