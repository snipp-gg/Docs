...
- Files are capped at 50 MB on the free plan and 200 MB on Snipp+ and Ultra, matching the per-file upload limit. Conversion runs inside the request, so a large video can take a while to come back.
